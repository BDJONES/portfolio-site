...
const projects: ProjectProps[] = [
    {
        ...
        story: "This project was a passion project that I built in my free time. I wanted to create a game that would be fun to play and would challenge my skills as a developer. I used Unity to build the game and I used the Unity Editor to build the game. I used the Unity Engine to build the game. I used the Unity API to build the game. I used the Unity SDK to build the game. I used the Unity API to build the game. I used the Unity SDK to build the game. I used the Unity API to build the game. I used the Unity SDK to build the game.",
        tech: ["Unity", "C#", "Blender", "GitHub", "Unity Cloud Services"],
        media: [
            {
                type: "image",
                src: "/images/project_assets/Pokemon_Battle_Evolution/PokemonThumbnail.png",
            },
            {
                type: "image",
                src: "/images/project_assets/Pokemon_Battle_Evolution/Pokemon1.png",
            },
            {
                type: "image",
                src: "/images/project_assets/Pokemon_Battle_Evolution/Pokemon2.png",
            },
        ],
    ...
    },
    {
        ...
        story: "This project was a project I built with one of my friends to keep my skills for software deve/game dev up. We used Unity to build this game, but took it upon ourselves to host meeting and truly collaborate with industry tools such as GitHub.",
        tech: ["Unity", "C#", "GitHub", "Audacity", "Adobe Illustrator"],
        media: [
            {
                type: "image",
                src: "/images/project_assets/Chess_Game_1999/ChessThumbnail.png",
            },
            {
                type: "image",
...
export default function ProjectsSection() {
    const [activeProject, setActiveProject] = useState<ProjectProps | null>(
        null,
    );
                            ...
                            <div className="project-dialog-grid">
                                ...
                                <div className="project-details">
                                    <div className="project-details-header">
                                        ...
                                        {activeProject.githubLink.length >
                                            0 && (
                                            <a
                                            ...
                                            >
                                                <span className="project-github-tooltip">
                                                    GitHub Repo
                                                </span>
                                                <img
